...
func seedFilterFixture(t *testing.T, client *LocalClient, projectID string) (todoID, doneID, urgentID string) {
	t.Helper()
	ctx := context.Background()
	...
	urgent, err := client.CreateTask(ctx, plugin.CreateTaskRequest{
	...
	return todo.ID, done.ID, urgent.ID
}
...
func TestListTasksFilters(t *testing.T) {
	...
	todoID, doneID, _ := seedFilterFixture(t, client, projectID)
