...
func (m *MainModel) handleTaskMessages(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tasks.TaskCreateMsg:
		...
		return m, tasks.LoadTasksInterface(m.programContext.TaskClient, m.programContext.SelectedProjectID)
...
func (m *MainModel) handleProjectModeMessages(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case projectmode.ProjectModeDeactivatedMsg:
		...
		if msg.ShouldLoadTasks {
			loadCmd := tasks.LoadTasksInterface(m.programContext.TaskClient, m.programContext.SelectedProjectID)
