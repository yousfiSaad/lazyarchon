...
type TaskItemUpdateMsg struct {
	...
	Task          interfaces.Task // Updated task data
...
type TaskItemClickedMsg struct {
	...
	Task  interfaces.Task // The clicked task
}
...
type TaskItemDataChangedMsg struct {
	Index   int             // Index of the task item
	OldTask interfaces.Task // Previous task data
	NewTask interfaces.Task // Updated task data
}
...
type TaskItemActionRequestMsg struct {
	Index  int             // Index of the task item
	Task   interfaces.Task // Task to perform action on
...
func NewTaskItemUpdate(index int, task interfaces.Task, isSelected, isHighlighted bool, searchQuery string) TaskItemUpdateMsg {
...
func NewTaskItemClicked(index int, task interfaces.Task) TaskItemClickedMsg {
...
func NewTaskItemDataChanged(index int, oldTask, newTask interfaces.Task) TaskItemDataChangedMsg {
...
func NewTaskItemActionRequest(index int, task interfaces.Task, action string) TaskItemActionRequestMsg {
