...
//
//nolint:gocyclo // Modal requires routing to 12+ message types for complete feature selection UX
...
func (m *FeatureModel) buildViewportContent() {
	...
	listItems := make([]string, 0, len(m.filteredFeatures)) // Preallocate for all features
