...
func (m *ProjectListModel) View() string {
	...
	lines := make([]string, 0, len(projects)+4) // Preallocate: header + spacing + projects + all tasks
...
func (m *ProjectListModel) renderProjectLine(project interfaces.Project, index int) string {
...
func (m *ProjectListModel) GetSelectedProject() *interfaces.Project {
...
//
//nolint:gocyclo // Complexity unavoidable - message router handling multiple message types
